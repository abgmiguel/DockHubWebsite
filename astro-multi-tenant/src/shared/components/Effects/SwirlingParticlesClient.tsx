      ...
      {particles.map((particle, index) => (
        <div
          ...
          style={{
            ...
            animation: `swirl ${particle.animationDuration}s infinite linear, pulse ${particle.pulseSpeed}s infinite ease-in-out, drift ${particle.driftSpeed}s infinite ease-in-out`,
